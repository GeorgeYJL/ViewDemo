...
public class GLMatrixStack {
    ...
    public static void reTranslate(float[] target, float x, float y, float z) {
        save();
        reset();
        Matrix.translateM(GLMatrixStack.getOpMatrix(), 0, target, 0,
                x, y, z);
    }
    ...
    public static void reRotate(float[] target, float deg, float x, float y, float z) {
        save();
        reset();
        Matrix.rotateM(GLMatrixStack.getOpMatrix(), 0, target, 0,
                deg, x, y, z);
    }
    ...
    public static void lookAt(float cx, float cy, float cz,
        ...
        GLWorldState.setCameraLocation(cx, cy, cz);//设置相机位置
